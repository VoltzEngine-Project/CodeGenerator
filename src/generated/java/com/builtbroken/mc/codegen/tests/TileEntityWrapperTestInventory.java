...
public class TileEntityWrapperTestInventory extends TileEntityWrapper implements IInventoryProvider, ISidedInventory
{
	public TileEntityWrapperTestInventory()
	{
		super(new TileTestInventory());
	}
