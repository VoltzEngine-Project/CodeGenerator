...
public class TileEntityWrapperTestEnergyInv extends TileEntityWrapper implements IEnergyBufferProvider, IInventoryProvider, ISidedInventory
{
	public TileEntityWrapperTestEnergyInv()
	{
		super(new TileTestEnergyInventory());
	}
